...
class rds_rx(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._freq_range = qtgui.Range(77, 108, 0.1, 99.9, 200)
        ...
        self.soapy_limesdr_source_0 = soapy.source(dev, "fc32", 1, 'driver=LimeSDR,soapy=0',
        ...
        self.connect((self.soapy_limesdr_source_0, 0), (self.qtgui_waterfall_sink_x_1, 0))
    ...
    def set_freq_tune(self, freq_tune):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(self.freq_tune, 2000000)
        self.qtgui_waterfall_sink_x_1.set_frequency_range(self.freq_tune, 2000000)
