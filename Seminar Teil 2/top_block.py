...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.tuning = tuning = 438950000
        self.sql_lvl = sql_lvl = -50
        ...
        self._tuning_range = qtgui.Range(430000000, 444000000, 12500, 438950000, 200)
        self._tuning_win = qtgui.RangeWidget(self._tuning_range, self.set_tuning, "Tuning", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._tuning_win, 2, 0, 1, 1)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._sql_lvl_range = qtgui.Range(-100, 0, 5, -50, 200)
        self._sql_lvl_win = qtgui.RangeWidget(self._sql_lvl_range, self.set_sql_lvl, "Squelch", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._sql_lvl_win)
        ...
        self.soapy_limesdr_source_0 = soapy.source(dev, "fc32", 1, 'driver=lime,soapy=0',
                                  stream_args, tune_args, settings)
        self.soapy_limesdr_source_0.set_sample_rate(0, samp_rate)
        self.soapy_limesdr_source_0.set_bandwidth(0, 0)
        self.soapy_limesdr_source_0.set_frequency(0, tuning)
        ...
        self.analog_simple_squelch_cc_0 = analog.simple_squelch_cc(sql_lvl, 1)
    ...
    def set_tuning(self, tuning):
        self.tuning = tuning
        self.qtgui_freq_sink_x_0.set_frequency_range(self.tuning, self.samp_rate)
        self.qtgui_waterfall_sink_x_0.set_frequency_range(self.tuning, self.samp_rate)
        self.soapy_limesdr_source_0.set_frequency(0, self.tuning)

    def get_sql_lvl(self):
        return self.sql_lvl

    def set_sql_lvl(self, sql_lvl):
        self.sql_lvl = sql_lvl
        self.analog_simple_squelch_cc_0.set_threshold(self.sql_lvl)
