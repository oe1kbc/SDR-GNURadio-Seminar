...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_range = qtgui.Range(431000000, 432000000, 12500, 431675000, 20)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(8000.0, analog.GR_COS_WAVE, 162.2, 0.1, 0, 0)
